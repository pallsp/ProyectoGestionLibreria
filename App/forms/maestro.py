...
class Interfaz(Window):
    def __init__(self):
        super().__init__(themename="superhero", size=(1410, 760), title="Menú principal") #proporcion 1.8
        #self.iconphoto(True, tk.PhotoImage(file="/home/pablo/PROYECTO/App/imagenes/librerio.png"))
        self.widgets()
        #Datos.crear()
        self.mostrar()
        self.idlibro = -1
