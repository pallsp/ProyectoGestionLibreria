...
class FormLoginDesigner:
    ...
    def __init__(self):
        ...
        inicio = tk.Button(frame_form_fill, text = "Iniciar sesión", font = ("Times", 15, BOLD), bg = "#3a7ff6", bd = 0, fg = "#fff", command = self.check_session) #command = self.check_session la función que se ejecutará
        ...
        registro = tk.Button(frame_form_fill, text = "Registrar usuario", font = ("Times", 15, BOLD), bg = "#fcfcfc", bd = 0, fg = "#3a7ff6", command = self.register_user) 
